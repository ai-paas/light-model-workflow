...
SWAGGER_TITLE = "AI-PaaS Lite Model Workflow"
SWAGGER_SUMMARY = "Lite Model Workflow Backend Server"
SWAGGER_DESCRIPTION = """
주요 기능
1. Model
    - REST API를 통해 최적화 및 경량화 시킬 모델과 최적화 방법, 파라미터들을 입력 받은 후, 최적화된 모델을 MLFlow에 저장합니다.
    - 최적화/경량화가 적용된 모델을 불러옵니다.
2. Optimize
    - REST API를 통해 최적화 및 경량화 시킬 모델과 최적화 방법, 파라미터들을 입력 받은 후, 최적화된 모델을 MLFlow에 저장합니다.
3. Info
    - REST API를 통해 최적화 및 경량화 시킬 수 있는 모델과 최적화 방법 정보를 표시합니다
    """
